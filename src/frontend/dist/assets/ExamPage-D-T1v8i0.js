import { r as reactExports, j as jsxRuntimeExports, R as ReactDOM, b as cn, d as useParams, a as useNavigate, P as ProctoringEventType, S as Skeleton, D as Difficulty } from "./index-CwS_SVxk.js";
import { P as Primitive, c as composeEventHandlers, d as dispatchDiscreteCustomEvent, e as useLayoutEffect2, u as useControllableState, f as createContext2, a as Presence, b as createContextScope, g as createSlot, h as createSlottable } from "./index-DX-_QWgz.js";
import { c as createLucideIcon, u as useComposedRefs, b as buttonVariants, B as Button, S as Shield } from "./shield-dCwcTvrC.js";
import { b as useCallbackRef$1, a as useId, u as useDirection, R as Root$1, I as Item, c as createRovingFocusGroupScope } from "./index-DJtJPTn2.js";
...
import { i as apiLogProctoringEvent, j as apiSubmitSession, k as apiStoreCameraFrame, d as apiListQuestions, l as apiStartSession } from "./backend-CRXSMnqx.js";
...
function difficultyBadge(d) {
  ...
  const m = map[d];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `text-xs border ${m.cls}`, children: m.label });
}
...
function ExamPageContent() {
  ...
  const [noiseEvents, setNoiseEvents] = reactExports.useState(0);
  const tabSwitchesRef = reactExports.useRef(0);
  const consecutiveNoiseRef = reactExports.useRef(0);
  ...
  const cameraIntervalRef = reactExports.useRef(null);
  const micIntervalRef = reactExports.useRef(null);
  ...
  const submitExam = reactExports.useCallback(
    async (auto) => {
      ...
      try {
        ...
        setSubmitting(false);
        ue.success("Exam submitted! Redirecting…", { duration: 2e3 });
        setTimeout(
          () => navigate({
    ...
    const handleVisibility = () => {
      if (document.hidden && !submittedRef.current) {
        ...
        if (tabSwitchesRef.current >= 2) {
          ue.warning("2 tab switches detected — auto-submitting exam.", {
            duration: 3e3
          });
          submitExam(true);
        } else {
  ...
  const startCamera = reactExports.useCallback(async () => {
    try {
      ...
      ue.warning("Camera unavailable — proctoring will log missing frames.");
    }
  }, []);
  const captureFrame = reactExports.useCallback(() => {
    if (!canvasRef.current || !videoRef.current || !actor || !user || !sessionId)
      return;
  ...
  const checkNoise = reactExports.useCallback(() => {
    ...
    if (rms > NOISE_THRESHOLD) {
      ...
      if (consecutiveNoiseRef.current >= 3) {
        ...
        ue.warning("Sustained noise detected and logged.", {
          duration: 3e3
        });
      }
    } else {
  ...
  reactExports.useEffect(() => {
    if (!sessionId || loading) return;
    const id = setInterval(captureFrame, 1e4);
    cameraIntervalRef.current = id;
    return () => clearInterval(id);
  }, [sessionId, loading, captureFrame]);
  reactExports.useEffect(() => {
    if (!sessionId || loading) return;
    const id = setInterval(checkNoise, 5e3);
    micIntervalRef.current = id;
    return () => clearInterval(id);
  }, [sessionId, loading, checkNoise]);
  const timerStartedRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  if (loadError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "max-w-sm w-full mx-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-10 h-10 text-destructive mx-auto mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground mb-2", children: "Error" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: loadError }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => navigate({ to: "/" }), children: "Return Home" })
        ] }) })
      }
    );
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-md bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-4 h-4 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-semibold text-foreground truncate", children: (exam == null ? void 0 : exam.roleTitle) ?? "Exam" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden sm:block text-xs text-muted-foreground", children: [
              "— ",
              answeredCount,
              "/",
              questions.length,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `flex items-center gap-2 px-4 py-1.5 rounded-lg border font-mono text-sm font-semibold transition-smooth ${isLowTime ? "bg-destructive/10 border-destructive/40 text-destructive" : "bg-muted/60 border-border text-foreground"}`,
              "data-ocid": "exam.timer",
              children: [
                formatTime(timeLeft),
                isLowTime && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs animate-pulse", children: "!" })
              ]
            }
          )
        ] }) }),
        (tabSwitches > 0 || noiseEvents > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-accent/15 border-b border-accent/30 px-4 py-2 flex items-center gap-3",
            "data-ocid": "exam.proctoring_banner",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-4 h-4 text-accent-foreground shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 text-xs text-accent-foreground", children: [
                tabSwitches > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                ...
                noiseEvents > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-3.5 h-3.5" }),
                  "Noise events: ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: noiseEvents })
                ] })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-5", children: [
                ...
                Card,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display font-medium text-foreground leading-snug flex-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-sm mr-2 font-mono", children: [
                          "Q",
                          i + 1,
                          "."
                        ] }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isMCQ ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      RadioGroup,
                      {
                        value: answers[qid] ?? "",
            ...
            questions.length === 0 && !loading && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Card,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-12 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-8 h-8 text-muted-foreground mx-auto mb-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No questions found for this exam." })
                ] })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-64 shrink-0 hidden lg:flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl overflow-hidden border border-border bg-card", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 border-b border-border flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-foreground", children: "Camera Preview" }),
                micActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-3.5 h-3.5 text-primary ml-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { className: "w-3.5 h-3.5 text-muted-foreground ml-auto" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-video bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "video",
                {
                  ref: videoRef,
                  autoPlay: true,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xs font-display uppercase text-muted-foreground tracking-wider", children: "Progress" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Answered" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mt-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Tab switches" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Noise events" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `font-mono font-medium ${noiseEvents > 0 ? "text-destructive" : "text-foreground"}`,
                      children: noiseEvents
                    }
                  )
                ] })
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden sticky bottom-0 bg-card border-t border-border px-4 py-3 flex items-center justify-between gap-3", children: [
        ...
        submitted && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-8 h-8 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-display font-semibold text-foreground mb-2", children: "Exam Submitted" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: submitting ? "Processing your results…" : "Redirecting to your results…" })
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: confirmOpen, onOpenChange: setConfirmOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "exam.submit_dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display", children: "Submit Exam?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              ...
              " questions.",
              " ",
              answeredCount < questions.length && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-destructive font-medium", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "exam.submit_cancel_button", children: "Keep working" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              AlertDialogAction,
              {
                onClick: () => {
                ...
                children: "Yes, Submit Now"
              }
            )
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, className: "hidden", tabIndex: -1 })
      ]
    }
  );
}
function Monitor(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Monitor" }),
...
function ExamPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExamPageContent, {}) });
}
export {
  ExamPage as default
};
