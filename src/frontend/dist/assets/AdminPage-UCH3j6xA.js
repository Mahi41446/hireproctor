import { r as reactExports, j as jsxRuntimeExports, b as cn, S as Skeleton, N as Navigate, E as ExamStatus, D as Difficulty } from "./index-CwS_SVxk.js";
...
import { C as Card, b as CardHeader, c as CardTitle, a as CardContent, d as CardDescription } from "./card-Rvghi0cc.js";
import { I as Input } from "./input-BieyMbL5.js";
import { L as Label } from "./label-DA6y1put.js";
import { u as useControllableState, P as Primitive, c as composeEventHandlers, a as Presence, b as createContextScope } from "./index-DX-_QWgz.js";
import { u as useDirection, a as useId, R as Root, I as Item, c as createRovingFocusGroupScope } from "./index-DJtJPTn2.js";
import { c as apiListExams, d as apiListQuestions, e as apiCreateExam, f as apiSetExamStatus, g as apiImportQuestions, h as apiGenerateQuestionsViaOllama } from "./backend-CRXSMnqx.js";
...
const CirclePlay = createLucideIcon("circle-play", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const CircleStop = createLucideIcon("circle-stop", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const DIFFICULTY_COLORS = {
  ...
  [Difficulty.expert]: "bg-destructive/10 text-destructive border-destructive/30"
};
const STATUS_CONFIG = {
  [ExamStatus.draft]: {
    label: "Draft",
...
function parseDifficulty(raw) {
  ...
  return map[(_a = raw == null ? void 0 : raw.toLowerCase) == null ? void 0 : _a.call(raw).trim()] ?? Difficulty.medium;
}
    ...
    reader.onload = (e) => {
      ...
      try {
        ...
        const parsed = rows.map((row) => ({
          ...
          options: String(row.options ?? row.Options ?? "").split(",").map((o) => o.trim()).filter(Boolean),
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/60 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium w-8", children: "#" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium", children: "Question" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium w-24", children: "Difficulty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium", children: "Options" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium", children: "Answer" }),
          onRemove && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "w-10 px-4 py-2.5 text-muted-foreground font-medium" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: questions.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "hover:bg-muted/30 transition-colors",
            "data-ocid": `questions.preview_row.${i + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground tabular-nums", children: i + 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-foreground max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "line-clamp-2", children: q.question_text }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DifficultyBadge, { difficulty: q.difficulty }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground max-w-[180px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate", children: q.options.length > 0 ? q.options.join(", ") : "—" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-foreground font-medium max-w-[120px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate", children: q.correct_answer || "—" }) }),
              onRemove && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => onRemove(i),
...
function LoadedQuestionsTable({ questions }) {
  if (questions.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-10 h-10 text-muted-foreground mb-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-medium", children: "No questions loaded yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Upload an Excel file or generate questions with AI above" })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/60 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium w-8", children: "#" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium", children: "Question" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium w-24", children: "Difficulty" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium", children: "Answer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-2.5 text-muted-foreground font-medium w-16", children: "Source" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: questions.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground tabular-nums", children: i + 1 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-foreground max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "line-clamp-2", children: q.questionText }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DifficultyBadge, { difficulty: q.difficulty }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-foreground max-w-[160px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate", children: q.correctAnswer }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: q.aiGenerated ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs text-primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3" }),
            " AI"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Excel" }) })
        ]
      },
      String(q.id)
    )) })
...
function AdminPageContent() {
  ...
  const sessionToken = (user == null ? void 0 : user.sessionToken) ?? "";
  const [exams, setExams] = reactExports.useState([]);
  const [examsLoading, setExamsLoading] = reactExports.useState(true);
  ...
  const [timerMinutes, setTimerMinutes] = reactExports.useState(30);
  const [passThreshold, setPassThreshold] = reactExports.useState(60);
  const [createLoading, setCreateLoading] = reactExports.useState(false);
  const [createError, setCreateError] = reactExports.useState("");
  const [parsedQuestions, setParsedQuestions] = reactExports.useState([]);
  ...
  reactExports.useEffect(() => {
    ...
    apiListQuestions(actor, sessionToken, selectedExamId).then(setQuestions).catch(() => setQuestions([])).finally(() => setQuestionsLoading(false));
  ...
  const handleConfirmUpload = async () => {
    if (!actor || !sessionToken || !selectedExamId || parsedQuestions.length === 0)
      return;
  ...
  const examUrl = selectedExam ? `${window.location.origin}/exam-entry?examId=${String(selectedExam.id)}` : "";
  const handleCopyUrl = () => {
  ...
  if (isFetching || examsLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-4", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Manage exams, questions, and candidate assessments" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "w-4 h-4 text-primary" }),
            "Create New Exam"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "role-title", children: "Job Role" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "timer", children: "Timer (min)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "timer",
                    ...
                    max: 180,
                    value: timerMinutes,
                    onChange: (e) => setTimerMinutes(Number.parseInt(e.target.value) || 30),
                    "data-ocid": "create_exam.timer_input"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "threshold", children: "Pass % " }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "threshold",
                    ...
                    max: 100,
                    value: passThreshold,
                    onChange: (e) => setPassThreshold(Number.parseInt(e.target.value) || 60),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  createLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin mr-2" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "w-4 h-4 mr-2" }),
                  "Create Exam"
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "All Exams" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: exams.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center justify-center py-10 text-center px-4",
              "data-ocid": "exams.empty_state",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FileSpreadsheet, { className: "w-8 h-8 text-muted-foreground mb-2" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No exams yet. Create one above." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-border", "data-ocid": "exams.list", children: exams.map((exam, i) => {
              ...
              "li",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `w-full text-left px-4 py-3 hover:bg-muted/40 transition-colors flex items-center justify-between gap-2 ${isSelected ? "bg-primary/5 border-l-2 border-primary" : ""}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: exam.roleTitle }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-0.5", children: [
                          String(exam.timerMinutes),
                          " min ·",
                          " ",
                          String(exam.passThresholdPercent),
                          "% pass"
                        ] })
                      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2 space-y-6", children: !selectedExam ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex flex-col items-center justify-center py-20 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileSpreadsheet, { className: "w-12 h-12 text-muted-foreground mb-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-medium", children: "Select or create an exam to get started" })
      ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 pb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-display font-semibold text-foreground", children: selectedExam.roleTitle }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border ${STATUS_CONFIG[selectedExam.status].color}`,
                    "data-ocid": "exam.status_badge",
                    children: STATUS_CONFIG[selectedExam.status].label
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-1", children: [
                "Timer: ",
                String(selectedExam.timerMinutes),
                " min · Pass threshold: ",
                String(selectedExam.passThresholdPercent),
                "% · ",
                questions.length,
                " question",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              selectedExam.status === ExamStatus.draft && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  size: "sm",
                  ...
                  children: [
                    statusLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlay, { className: "w-4 h-4" }),
                    "Activate Exam"
                  ]
                }
              ),
              selectedExam.status === ExamStatus.active && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  size: "sm",
                  variant: "destructive",
                  ...
                  children: [
                    statusLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleStop, { className: "w-4 h-4" }),
                    "Close Exam"
                  ]
                }
              )
          ...
          selectedExam.status === ExamStatus.active && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { className: "w-4 h-4 text-primary shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground font-mono flex-1 truncate", children: examUrl }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "sm",
                    ...
                    children: [
                      urlCopied ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-chart-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-4 h-4" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Load Questions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Upload from Excel or generate with AI for this exam" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Tabs,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "upload", className: "space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "label",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CloudUpload, { className: "w-8 h-8 text-muted-foreground mx-auto mb-2" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Drop your .xlsx file here or click to browse" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Columns: question_text, difficulty, options (comma-separated), correct_answer" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            ref: fileInputRef,
                  ...
                  uploadSuccess && parsedQuestions.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                  ...
                  parsedQuestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        Button,
                        {
                          ...
                          children: [
                            uploadLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4" }),
                            "Save Questions"
                          ]
                        }
                      )
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "ai", className: "space-y-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ai-role", className: "sr-only", children: "Job role for AI generation" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          id: "ai-role",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Generates 4 questions (1 easy, 1 medium, 1 hard, 1 expert) using Ollama AI and saves them to the exam automatically." }),
                  aiLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Generating questions…" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Calling Ollama AI — this may take a few seconds" })
                        ] })
                      ]
                    }
                  ),
                  aiError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-destructive", children: aiError }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              type: "button",
                              ...
                              children: "Switch to Upload Excel tab"
                            }
                          )
                        ] })
                      ]
                  ...
                  aiSuccess && aiPreview.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: "flex items-center gap-2 p-3 rounded-md bg-chart-3/10 border border-chart-3/20 text-sm text-chart-3",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(QuestionPreviewTable, { questions: aiPreview })
                  ] })
                ] })
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Loaded Questions" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-xs mt-0.5", children: "All questions for this exam" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: questionsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "space-y-2",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx(LoadedQuestionsTable, { questions }) })
        ] })
      ] }) })
    ] })
  ] }) });
...
function AdminPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminPageContent, {}) });
}
export {
